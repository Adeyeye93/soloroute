defmodule PhxProj.Accounts.User do
  use PhxProj.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, PhxProj.Repo)
  ...
  """
  def valid_password?(%PhxProj.Accounts.User{hashed_password: hashed_password}, password)
